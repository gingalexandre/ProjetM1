                    ...
                    rectangle.setOnMousePressed(new EventHandler<MouseEvent>() {
                        public void handle(MouseEvent me){
                            try {
                                ...
                                serveur.getGestionnaireUI().diffuserMessage(new Message("La route la plus longue du Joueur :  "+joueurCourrant.getNomUtilisateur()+" est de "+maRouteLaPlusLongue+"."));
    ...
    public void jouerCarte() throws RemoteException {
        ...
        if (index != -1) {
            ...
            if (carte != null) {
                ...
                popErreur("Aucune carte sélectionnée.");
            }
            disableBoutonConstruction(false);
        }
    }
